                        ...
                        justifyContent: "center"
                          ...
                          onChange: (function ($$event) {
                              ...
                              return Curry._1(setNewTime, (function (old) {
                                            return {
                                                    minutes: Pervasives.abs(Util$FeedbackHelper.int_from_string($$event.target.value)),
                                                    seconds: old.seconds
                                                  };
                                          }));
                            }),
                          ...
                          onChange: (function ($$event) {
                              ...
                              return Curry._1(setNewTime, (function (old) {
                                            return {
                                                    minutes: old.minutes,
                                                    seconds: Pervasives.abs(Util$FeedbackHelper.int_from_string($$event.target.value))
                                                  };
                                          }));
                            }),
                          type: "number",
